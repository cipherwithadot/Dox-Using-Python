...
name_cmd = "#NationSquadDox - Coded by akaMineSyntax "

#Coded By akaMineSyntax - #NationSquad


os.system("cls")
menu_principal = """
 _______          __  .__              ________                
 \      \ _____ _/  |_|__| ____   ____ \______ \   _______  ___
 /   |   \\__  \\   __\  |/  _ \ /    \ |    |  \ /  _ \  \/  /
/    |    \/ __ \|  | |  (  <_> )   |  \|    `   (  <_> >    < 
\____|__  (____  /__| |__|\____/|___|  /_______  /\____/__/\_ \
        \/     \/                    \/        \/            \/
...
def google():
	...
	nom = input(Fore.RED + "  [NationSquadDox] " + Fore.CYAN + "Introduzca datos: " + Fore.WHITE)
...
def SearchEmail():
	print()
	email = input(Fore.RED + "  [NationSquadDox] " + Fore.CYAN + "Introduce un correo: " + Fore.WHITE)
...
def searchUserName():
	print()
	username = input(Fore.RED + "  [NationSquadDox]" + Fore.CYAN + " Introduce un nick: " + Fore.WHITE)
...
print()
print(Fore.YELLOW + " " * 2 + " Official Tool NationSquad Private Coded by akaMineSyntax")
print(menu)
try:
	while True:
		parametros = input(Fore.MAGENTA + "  root@nationsquad ═> " + Fore.WHITE)
		if parametros == "1":
			SearchEmail()
		elif parametros == "2":
			searchUserName()
			...
			print()
			user = input(Fore.RED + "  [NationSquadDox] " + Fore.CYAN + "Introduce un nick de minecraft: " + Fore.WHITE)
			nick = user.lower()
			...
			print(Fore.RED + menu_principal)
			print()
			print(Fore.YELLOW + " " * 2 + " Official Tool of NationSquad Private Coded by akaMineSyntax")
			print(menu)
except KeyboardInterrupt:
	print(Fore.RED + "\n\n  [NationSquadDox]" + Fore.GREEN + " Saliendo de la tool..." + Fore.WHITE)
	time.sleep(1.5)
except:
	pass
